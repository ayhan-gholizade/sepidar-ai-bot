...
# توکن‌ها از محیط امن
BALE_TOKEN = os.environ.get("1067449233:Wd5MDS71xoPEhKIk2nH6N7dnDnHWvuK5v7s")
GEMINI_API_KEY = os.environ.get("AIzaSyBhbiOFG9-7z8ELNqizVWeoJnZmONKgjxY")
...
async def on_message(message: Message):
    ...
    # بررسی اینکه آیا چت هنوز خالیه (یعنی پرامپت معرفی لازم هست)
